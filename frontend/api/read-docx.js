        ...
        try {
            ...
            if (prompt && prompt.trim().length > 2) {
                aiPrompt = `
                    ...
                    Answer in detail and please analyze the document and provide relevant information. Then, suggest follow-up questions the user may want to ask or next actions to consider.
                `.trim();
            } else {
